  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.code === 'auth/email-already-in-use') {
        setPopupMessage('Email đã được sử dụng')
      } else {
      ...
      <main className="login-main">
        <div className="login-card" id="login-card">
          ...
          <p className="login-card__subtitle">
            Join VIBIO to enjoy unlimited movies &amp; series.
          </p>
          ...
          <form className="login-form" id="login-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className={`input-group ${focusedField === 'confirmPassword' ? 'focused' : ''} ${confirmPassword ? 'has-value' : ''} ${errors.confirmPassword ? 'error' : ''}`}>
              ...
              <div className="input-group__field">
                <input
                  ...
                  required
                />
                <label htmlFor="input-confirm-password">Enter Password Again</label>
              </div>
              <button
                type="button"
                className="input-group__toggle"
            ...
            {/* Remember me & Forgot */}
            <div className="login-form__options" id="login-form-options">
